...
public class mossySlabItemOther extends ItemSlab {
	...
	public mossySlabItemOther(Block block, BlockSlab halfslab, BlockSlab doubleslab) {
		super(block, halfslab, doubleslab);

		this.setMaxDamage(0);
        this.setHasSubtypes(true);
        this.setUnlocalizedName("stoneMossyBrickSlab");
...
/*	
    ...
    {
		this.itemIcon = register.registerIcon("thejungle:mossySmoothStone");
    ...
    {
        return w2theJungle.mossyStoneSlabSingle.getIcon(2, par1  & 7);
    }
