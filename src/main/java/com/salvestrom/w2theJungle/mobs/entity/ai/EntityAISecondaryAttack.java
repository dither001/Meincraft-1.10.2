...
public class EntityAISecondaryAttack extends EntityAIBase {
	...
	public EntityAISecondaryAttack(IRangedAttackMob p_i1649_1_, double p_i1649_2_, int p_i1649_4_, float p_i1649_5_, float f)
    {
        this(p_i1649_1_, p_i1649_2_, p_i1649_4_, p_i1649_4_, p_i1649_5_, f);
    }

    public EntityAISecondaryAttack(IRangedAttackMob p_i1650_1_, double p_i1650_2_, int p_i1650_4_, int p_i1650_5_, float p_i1650_6_, float f)
    {
    ...
    public boolean shouldExecute()
    {
        ...
        else if(this.entityHost.getDistanceToEntity(entitylivingbase) < this.minimumRange)
        {
        	//this works pretty well.
        	this.entityHost.attackEntityAsMob(entitylivingbase);
        	return false;
        }
        else
        {
