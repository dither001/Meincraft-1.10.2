...
public class RenderLizardmanWitchDoctor extends RenderLiving
{
	public static final ResourceLocation Lizardman = new ResourceLocation("thejungle:textures/mobs/lizardmanwitchdoctor.png");
	protected ModelLizardmanWitchDoctor model;
	
	public RenderLizardmanWitchDoctor(RenderManager rm, ModelBase par1ModelBase, float par2) {
		super(rm, par1ModelBase, par2);
		this.model = ((ModelLizardmanWitchDoctor)super.mainModel);
   ...
   //onItemRightClick (cool stuff) 
    protected void renderEquippedItems(EntityLizardmanWitchDoctor par1EntityLiving, float par2)
    {
        ...
        if (itemstack1 != null)
        {
            ...
            else if (item == Items.SKULL)
            {
                ...
                TileEntitySkullRenderer.instance.renderSkull(-0.5F, 0.0F, -0.5F, EnumFacing.UP, 180.0F, itemstack.getMetadata(), gameprofile, -1, par2);
            }
