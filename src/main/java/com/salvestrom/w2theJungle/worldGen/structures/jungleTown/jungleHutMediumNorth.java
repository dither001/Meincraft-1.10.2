...
public class jungleHutMediumNorth extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		bridge.setBlock(world, i + 0, j + 5, k + 4, JungleBlocks.mossyslabSingle, 6, 2);
		...
		bridge.setBlock(world, i + 2, j + 5, k + 5, JungleBlocks.mossystairs, 7, 2);
		...
		bridge.setBlock(world, i + 3, j + 3, k + 5, JungleBlocks.mossyStoneSteps, 3, 2);
		...
		bridge.setBlock(world, i + 3, j + 5, k + 5, JungleBlocks.mossystairs, 7, 2);
		...
		bridge.setBlock(world, i + 4, j + 5, k + 5, JungleBlocks.mossystairs, 7, 2);
		...
		bridge.setBlock(world, i + 5, j + 2, k + 1, JungleBlocks.mossystairs, 2, 2);
		...
		bridge.setBlock(world, i + 5, j + 3, k + 5, JungleBlocks.mossyStoneSteps, 3, 2);
		...
		bridge.setBlock(world, i + 5, j + 5, k + 1, Blocks.STONE_STAIRS, 6, 2);
		...
		bridge.setBlock(world, i + 5, j + 5, k + 5, Blocks.STONE_STAIRS, 7, 2);
		...
		bridge.setBlock(world, i + 6, j + 5, k + 5, Blocks.STONE_STAIRS, 7, 2);
		...
		if(rand.nextInt(2)==0) {
			...
			if(world.getBlockState(pos.add(6, 0, 2)).getBlock() != Blocks.AIR) {
				bridge.setBlock(world, i + 6, j + 1, k + 2, Blocks.CHEST, 3, 2);
