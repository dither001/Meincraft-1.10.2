...
public class jungleHutSmallNorth extends WorldGenerator
{
	...
	public boolean generate(World world, Random rand, int i, int j, int k) {
		...
		bridge.setBlock(world, i + 1, j + 3, k - 3, JungleBlocks.mossystairs, 0, 2);
		...
		bridge.setBlock(world, i + 2, j + 5, k - 5, Blocks.STONE_STAIRS, 6, 2);
		...
		bridge.setBlock(world, i + 3, j + 1, k - 4, JungleBlocks.mossyslabSingle, 0, 2);
		...
		bridge.setBlock(world, i + 3, j + 3, k - 1, Blocks.STONE_STAIRS, 3, 2);
		...
		bridge.setBlock(world, i + 3, j + 5, k - 5, Blocks.STONE_STAIRS, 6, 2);
		...
		bridge.setBlock(world, i + 4, j + 5, k - 1, JungleBlocks.mossystairs, 7, 2);
		...
		bridge.setBlock(world, i + 3, j + 2, k - 2, Blocks.TORCH,  0, 2);
		bridge.setBlock(world, i + 3, j + 2, k - 5, Blocks.JUNGLE_DOOR, 1, 2);
		...
		if(rand.nextInt(2)==0) {
			...
			{
				bridge.setBlock(world, i+3, j+1, k-2, Blocks.CHEST, 2, 2);
